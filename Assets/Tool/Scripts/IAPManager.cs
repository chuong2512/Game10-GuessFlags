...
public class IAPKey
{
    public const string PACK1 = "guess_flag_1";
    public const string PACK2 = "guess_flag_2";
    public const string PACK3 = "guess_flag_3";
    public const string PACK4 = "guess_flag_4";
    public const string PACK5 = "guess_flag_5";
    public const string PACK6 = "guess_flag_6";

    public const string PACK1_REGISTER = "guess_register_flag_1";
    public const string PACK2_REGISTER = "guess_register_flag_2";
    public const string PACK3_REGISTER = "guess_register_flag_3";
    public const string PACK4_REGISTER = "guess_register_flag_4";
    public const string PACK5_REGISTER = "guess_register_flag_5";
}
